package me.chuck.chuckhack.mixin.mixins.chuckhack.gui;
...
import me.chuck.chuckhack.Commands;
...
public class Gui extends GuiScreen {
	...
	public void drawScreen(int mouseX2, int mouseY2, float partialTicks) {		
		...
		if (GuiSettings.infoBox.booleanValue()) {
			...
			drawStringWithShadow(ChatFormatting.RED + "Made by: " + ChatFormatting.GREEN + "chucK", 2, 12, 0xFF000000);
			drawStringWithShadow(ChatFormatting.RED + "Discord: " + ChatFormatting.GREEN + Mod.DISCORD, 2, 22, 0xFF000000);
			drawStringWithShadow(ChatFormatting.RED + "Github: " + ChatFormatting.GREEN + "chuck/chuckhack", 2, 32, 0xFF000000);
