...
import me.chuck.chuckhack.mixin.mixins.chuckhack.gui.Settings;
import me.chuck.chuckhack.mixin.mixins.chuckhack.utils.Timer;
...
public class StashLogger extends Mod {
	...
	public StashLogger() {
		super(Group.WORLD, "StashLogger", "Logs chunks that have many container blocks in them", "It logs them to .minecraft/chuckhack/StashLogger.txt");
	}
