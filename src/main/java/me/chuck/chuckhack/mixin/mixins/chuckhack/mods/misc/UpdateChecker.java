...
public class UpdateChecker extends Mod {
	...
	public static String link = "https://raw.githubusercontent.com/chuck/chuckhack/main/UpdateChecker.txt";
	private String newVersion = null;
	
	public UpdateChecker() {
		super(Group.MISC, "UpdateChecker", "Checks if theres a new version of chuckhack in startup", "And notifies you in chat if you are running an outdated version");
		this.defaultOn = true;
	...
	public void onTick(ClientTickEvent e) {
		if (mc.player != null) {
			if (newVersion != null && !newVersion.equals(VERSION)) {
				String link = "https://github.com/chuck/chuckhack/releases/v" + newVersion;
